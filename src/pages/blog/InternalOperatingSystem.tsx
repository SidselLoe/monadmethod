...
const InternalOperatingSystem = () => {
  ...
  return (
    <BlogPostLayout
      ...
      excerpt="It's not strategy. It's not mindset. It's the layer underneath both."
      readTime="6 min read"
      ctaTitle="Ready to work lower?"
      ctaBody="If you've done the mindset work and the patterns are still running, book a call. No pitch. Just a conversation about what's underneath and whether the work is right for you."
    >
