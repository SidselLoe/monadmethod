...
const MeaningCeiling = () => {
  ...
  return (
    <BlogPostLayout
      ...
      readTime="5 min read"
      ctaTitle="Recognize the ceiling?"
      ctaBody="If this read like a description of where you are, book a call. No pitch. Just a conversation about what's underneath the results and whether the work is right for you."
    >
