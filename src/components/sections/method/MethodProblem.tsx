  ...
  return (
    <section className="bg-background py-24 sm:py-28 px-6">
      <div className="max-w-[600px] mx-auto text-center">
        ...
        <div className="mt-8 space-y-5 text-base text-foreground leading-[1.6] text-left sm:text-center">
          <p>
        ...
        <p className="mt-8 text-lg sm:text-xl font-medium text-foreground">
