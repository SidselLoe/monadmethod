...
const Footer = () => {
  return (
    <footer className="bg-foreground px-6 py-16 sm:py-20">
      <div className="max-w-[1200px] mx-auto">
        {/* Top row */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <img src={logoWhite} alt="Sidsel Løschenkohl" className="h-6 sm:h-7" />
        ...
        <div className="mt-10 max-w-[480px]">
          ...
          <p className="mt-5 text-lg sm:text-xl font-medium text-background">
            150+ founders are already shifting how they operate.
          </p>
          <p className="mt-2 text-base text-white/60 leading-[1.5]">
        ...
        <div className="mt-12 border-t border-white/10 pt-6 text-center">
          <p className="text-[13px] text-white/40">
            © Monad 42 Ltd. All rights reserved.{" "}
