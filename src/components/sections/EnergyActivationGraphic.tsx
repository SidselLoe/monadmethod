...
const EnergyActivationGraphic = () => (
  <div className="w-full rounded-xl overflow-hidden border border-[#E8E8E8] flex flex-col" style={{ height: 300, boxShadow: "0 2px 8px rgba(0,0,0,0.06), 0 12px 40px rgba(0,0,0,0.08)" }}>
    {/* Browser bar */}
