        ...
        <div className="mt-10 max-w-[720px] mx-auto bg-background border border-border rounded-xl p-8 sm:p-10">
          <div className="flex flex-col sm:flex-row items-start gap-5 text-left">
            ...
            <div className="flex-1">
              ...
              <Link
                to="/monad-method"
                className="inline-flex mt-6 bg-accent text-accent-foreground text-sm font-semibold uppercase tracking-[0.5px] px-10 py-4 rounded-full hover:bg-accent/90 transition-colors"
              >
                Learn More
              </Link>
            </div>
